...
set multiplot layout 3, 1 title "Streaming back pressure branch, reactive stream receiver, rate estimator PID(-1, 0, 0), one execution time spike"

set xrange [ -7549 : 496925 ]
set xtics format " "
set bmargin 1
