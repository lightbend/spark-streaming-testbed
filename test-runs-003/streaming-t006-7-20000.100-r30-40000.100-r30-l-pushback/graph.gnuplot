...
set multiplot layout 3, 1 title "Streaming back pressure branch, TCP receiver, congestion strategy: pushback. Long spikes, high volume"

set xrange [ -9496 : 1180032 ]
set xtics format " "
set bmargin 1
...
plot "execution.log" using 2:($3) with filledcurve x1 title "Spark - # of items 7 processed per batch" lt 1 lc 3, \
