...
set multiplot layout 3, 1 title "Streaming back pressure branch, TCP receiver, congestion strategy: drop. Longer-longer spikes? Less volume"

set xrange [ -10477 : 800029 ]
set xtics format " "
set bmargin 1
