...
set multiplot layout 3, 1 title "Streaming back pressure branch, TCP receiver, congestion strategy: pushback. Long spikes"

set xrange [ -7285 : 1235020 ]
set xtics format " "
set bmargin 1
...
plot "execution.log" using 2:($3) with filledcurve x1 title "Spark - # of items 13 processed per batch" lt 1 lc 3, \
...
"tick.log" using 1:($2) with fillsteps title "testbed, # of item 13 to send at each second" lt 1 lc 3
unset multiplot
